...
<html lang="en">
  ...
  <body onload="setInterval('chat.update()', 1000)">
	...
	<div class="container">
		<h1 class="mt-4 mb-3">
			Clinic <small>MIBT Online</small>
		</h1>
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<h2>Clinic</h2>
					<p>Welcome to MIBT Online. Click the "Open Chat"
						button to use the live chat. This feature can be turned off at
						anytime, <b>If this page doesn't work click here to goto alternate link <a href="https://www.youtube.com/">click here</a></b></p>
					<div id="page-wrap">
						<p id="name-area"></p>
